package nl.jorisdormans.graph
{
   ...
   public class GraphConnection extends GraphElement
   {
      ...
      public function getPositionOnLine(param1:Number) : Vector3D
      {
         ...
         {
            if((_loc6_ = (_loc5_ = this.points[_loc3_].subtract(this.points[_loc3_ - 1])).normalize()) >= _loc2_)
            {
      ...
      public function findClosestPointTo(param1:Number, param2:Number) : Number
      {
         ...
         {
            _loc10_ = (_loc9_ = this.points[_loc8_].subtract(this.points[_loc8_ - 1])).normalize();
            ...
            if((_loc13_ = _loc12_.length) < _loc4_)
            {
               _loc4_ = _loc13_;
      ...
      override public function generateXML() : XML
      {
         ...
         while(_loc4_ < _loc3_)
         {
            (_loc5_ = <point/>).@x = Math.round(this.points[_loc4_].x);
      ...
      override public function readXML(param1:XML) : void
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:int = param1.point.length();
