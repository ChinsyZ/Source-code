package nl.jorisdormans.machinations.model
{
   ...
   public class Gate extends MachinationsNode
   {
      ...
      override public function prepare(param1:Boolean) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            if(_loc5_ = outputs[_loc4_] as MachinationsConnection)
            {
               ++resourceOutputCount;
      ...
      private function produce(param1:uint, param2:MachinationsConnection) : void
      {
         ...
         var _loc4_:StateConnection;
         if(_loc4_ = param2 as StateConnection)
         {
            _loc4_.fire();
         }
      }
      ...
      private function distributeColorCoded(param1:uint) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((Boolean(_loc4_ = outputs[_loc3_] as MachinationsConnection)) && _loc4_.color == param1)
            {
      ...
      private function distributeProbable(param1:uint) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if(_loc6_ = outputs[_loc4_] as MachinationsConnection)
            {
      ...
      private function distributeConditional(param1:uint) : void
      {
         ...
         if(!_loc2_)
         {
            ...
            while(_loc4_ < _loc3_)
            {
               if((Boolean(_loc5_ = outputs[_loc4_] as MachinationsConnection)) && _loc5_.label.type == Label.TYPE_ELSE)
               {
                  this.produce(param1,_loc5_);
               }
               _loc4_++;
      ...
      public function checkDynamicProbabilities() : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if((_loc5_ = outputs[_loc4_] as MachinationsConnection).label.type == Label.TYPE_PROBABILITY_DYNAMIC)
            {
               _loc2_++;
            }
            if(_loc5_.label.type == Label.TYPE_PROBABILITY)
