   ...
   public class XMLConverter
   {
      ...
      private static function convertNodeV2V30(param1:XML) : XML
      {
         ...
         switch(_loc3_)
         {
            ...
            case "Gate":
               _loc2_.@symbol = "Gate";
               _loc4_ = (_loc4_ = param1.@type).toLowerCase();
      ...
      private static function convertConnectionV2V30(param1:XML, param2:int) : XML
      {
         ...
         if((_loc4_ = int(param1.@start)) < 0)
         {
            (_loc11_ = <point/>).@x = param1.@startX;
         ...
         for each(_loc8_ in _loc7_)
         {
            ...
            {
               (_loc11_ = <point/>).@x = _loc8_.@x;
               _loc11_.@y = _loc8_.@y;
               _loc3_.appendChild(_loc11_);
            }
         }
         _loc3_.@end = param1.@end;
         if((_loc5_ = int(param1.@end)) < 0)
         {
            (_loc11_ = <point/>).@x = param1.@endX;
         ...
         {
            _loc5_ -= param2;
            _loc5_ = (_loc5_ = Math.floor(_loc5_ / 2)) + param2;
            _loc3_.@end = _loc5_;
         }
         if(_loc4_ > param2)
         {
            _loc4_ -= param2;
            _loc4_ = (_loc4_ = Math.floor(_loc4_ / 2)) + param2;
            _loc3_.@start = _loc4_;
         }
         return _loc3_;
      }
