package nl.jorisdormans.machinations.view
{
   ...
   public class MachinationsDraw
   {
      ...
      {
         var _loc9_:XML;
         (_loc9_ = DrawUtil.drawRectToSVG(param2,param3,param7,param8,"none",StringUtil.toColorStringSVG(param5),1))["stroke-dasharray"] = "6,7";
      ...
      public static function generateConnectionData(param1:MachinationsConnection, param2:Vector.<int>, param3:Vector.<Number>, param4:Number, param5:Number, param6:Boolean) : void
      {
         ...
         if(param6)
         {
            _loc8_ = (_loc7_ = param1.points[param1.points.length - 1].clone()).subtract(param1.points[param1.points.length - 2]);
            _loc7_.x += param4;
            _loc7_.y += param5;
            _loc8_.normalize();
            ...
            _loc8_ = (_loc7_ = param1.points[0].clone()).subtract(param1.points[1]);
            _loc7_.x += param4;
            _loc7_.y += param5;
            _loc8_.normalize();
            param2.push(GraphicsPathCommand.MOVE_TO,GraphicsPathCommand.LINE_TO,GraphicsPathCommand.MOVE_TO,GraphicsPathCommand.LINE_TO,GraphicsPathCommand.LINE_TO);
         ...
         switch(param1.type.lineStyle)
         {
            ...
            case GraphConnectionType.STYLE_DOTTED:
               ...
               {
                  _loc17_ = (_loc16_ = param1.points[_loc9_ + 1].subtract(param1.points[_loc9_])).normalize();
