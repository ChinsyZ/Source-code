package nl.jorisdormans.machinations.view
{
   ...
   public class MachinationsEditView extends MachinationsView
   {
      ...
      private function saveAsSVG(param1:PhantomButton) : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            if(_loc6_ = drawPanel.getChildAt(_loc5_) as MachinationsViewElement)
            {
      ...
      private function onKeyDown(param1:KeyboardEvent) : void
      {
         ...
         {
            if(this.lastSelected && this.lastSelected.unique && this.lastSelected.element is GraphConnection)
            {
               this.addUndo();
      ...
      private function onMouseMove(param1:MouseEvent) : void
      {
         ...
         var _loc4_:MachinationsViewElement;
         if((_loc4_ = getElementAt(_loc2_,_loc3_)) && _loc4_ == this.lastSelected && _loc4_.unique)
         {
            _loc4_.hoveringControl = _loc4_.pointOnControl(_loc2_,_loc3_);
         }
         if(!(_loc4_ = getElementAt(_loc2_,_loc3_,this.lastSelected)) || !_loc4_.selected)
         {
            hover = _loc4_;
         }
         if(this.addingConnection)
      ...
      private function addConnection(param1:MouseEvent) : void
      {
         ...
         if(_loc2_ && _loc2_.selected && _loc2_.element is GraphConnection)
         {
            this.activateSelect();
            this.doSelect(param1);
            return;
      ...
      private function addConnectionPoint(param1:MouseEvent) : void
      {
         ...
         else
         {
            ...
            if((_loc6_ = _loc4_ * _loc4_ + _loc5_ * _loc5_) < MachinationsViewElement.CONTROL_SIZE * MachinationsViewElement.CONTROL_SIZE)
            {
      ...
      private function addNode(param1:MouseEvent) : void
      {
         ...
         var _loc3_:Point = drawPanel.trySnap(param1.localX,param1.localY);
         var _loc4_:String;
         if((_loc4_ = this.tool) == "TextL")
         {
            _loc4_ = "TextLabel";
         }
         var _loc5_:MachinationsNode;
         if((Boolean(_loc5_ = this.graph.addNode(_loc4_,new Vector3D(param1.localX + _loc3_.x,param1.localY + _loc3_.y)) as MachinationsNode)) && this.lastElement is MachinationsNode)
         {
      ...
      private function doSelect(param1:MouseEvent) : void
      {
         ...
         if(this.lastSelected && this.lastSelected.unique && this.lastSelected != _loc4_)
         {
      ...
      private function endDragControl(param1:MouseEvent) : void
      {
         ...
         if(this.dragging)
         {
            if((_loc5_ = drawPanel.trySnap(_loc2_,_loc3_)).x != 0 && _loc5_.y != 0)
            {
         ...
         if(_loc4_ = this.lastSelected.element as MachinationsConnection)
         {
      ...
      private function deleteSelected() : void
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         if(this.lastSelected && this.lastSelected.unique && this.lastSelected.control >= 0)
         {
            this.addUndo();
      ...
      public function generateSelectionXML() : XML
      {
         ...
         var _loc4_:XML;
         (_loc4_ = <graph/>).@version = MachinationsGrammar.version;
