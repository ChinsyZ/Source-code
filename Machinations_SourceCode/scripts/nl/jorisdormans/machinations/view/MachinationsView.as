package nl.jorisdormans.machinations.view
{
   ...
   public class MachinationsView extends PhantomBorder
   {
      ...
      protected function onMouseDownView(param1:MouseEvent) : void
      {
         ...
         if(this.hover && this.hover.element is MachinationsNode && (this.hover.element as MachinationsNode).activationMode == MachinationsNode.MODE_INTERACTIVE)
         {
      ...
      {
         var _loc4_:int;
         var _loc5_:int = (_loc4_ = int(this._elements.length)) - 1;
         while(_loc5_ >= 0)
         {
