package nl.jorisdormans.machinations.view
{
   ...
   public class MachinationsViewElement extends Sprite
   {
      ...
      public function draw() : void
      {
         ...
         var _loc4_:MachinationsConnection;
         if((Boolean(_loc4_ = this.element as MachinationsConnection)) && _loc4_.points.length > 1)
         {
            ...
            if((Boolean(_loc16_ = _loc4_ as ResourceConnection)) && !_loc16_.instantaneous)
            {
      ...
      public function pointInElement(param1:Number, param2:Number) : Boolean
      {
         ...
         var _loc4_:MachinationsNode;
         if(_loc4_ = this.element as MachinationsNode)
         {
            _loc6_ = param1 - _loc4_.position.x;
            _loc7_ = param2 - _loc4_.position.y;
            if((_loc8_ = _loc6_ * _loc6_ + _loc7_ * _loc7_) < _loc4_.size * _loc4_.size)
            {
               return true;
            }
         ...
         var _loc5_:MachinationsConnection;
         if(_loc5_ = this.element as MachinationsConnection)
         {
            _loc9_ = new Vector3D(param1,param2);
            if(this.pinsOnly)
            {
               (_loc12_ = _loc5_.points[1].subtract(_loc5_.points[0])).normalize();
               _loc12_.scaleBy(7);
               ...
               (_loc12_ = _loc5_.points[_loc5_.points.length - 1].subtract(_loc5_.points[_loc5_.points.length - 2])).normalize();
               _loc12_.scaleBy(-7);
            ...
            {
               _loc13_ = (_loc12_ = _loc5_.points[_loc11_].subtract(_loc5_.points[_loc11_ - 1])).normalize();
               if((_loc14_ = MathUtil.distanceToLine(_loc5_.points[_loc11_ - 1],_loc12_,_loc13_,_loc9_)) < SELECTED_THICKNESS)
               {
                  return true;
               }
               _loc11_++;
      ...
      public function pointOnControl(param1:Number, param2:Number) : int
      {
         ...
         if(_loc3_)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if((_loc10_ = _loc8_ * _loc8_ + _loc9_ * _loc9_) < CONTROL_SIZE * CONTROL_SIZE)
               {
                  return _loc7_ + 1;
               }
               _loc7_++;
         ...
         var _loc4_:MachinationsNode;
         if((_loc4_ = this.element as MachinationsNode) is TextLabel)
         {
            return -1;
         }
         if(_loc4_)
      ...
      public function moveBy(param1:int, param2:int) : void
      {
         ...
         var _loc4_:MachinationsConnection;
         if(_loc4_ = this.element as MachinationsConnection)
         {
      ...
      public function moveControl(param1:Number, param2:Number, param3:Number, param4:Number) : void
      {
         ...
         var _loc13_:Number = NaN;
         var _loc5_:GroupBox;
         if(_loc5_ = this.element as GroupBox)
         {
            switch(this._control)
            {
               case 0:
                  ...
                  while(_loc11_ <= _loc10_)
                  {
                     ...
                     if((_loc12_ = param1 * param1 + param2 * param2) < _loc9_)
                     {
                        _loc8_ = _loc11_;
                        _loc9_ = _loc12_;
                     }
         ...
         var _loc6_:MachinationsNode;
         if(_loc6_ = this.element as MachinationsNode)
         {
            if(this._control == 0)
            {
               if((_loc13_ = (_loc13_ = (_loc13_ = Math.atan2(param4 - y,param3 - x)) / (Math.PI * 2)) % 1) < 0)
               {
                  _loc13_ += 1;
               }
         ...
         var _loc7_:MachinationsConnection;
         if(_loc7_ = this.element as MachinationsConnection)
         {
