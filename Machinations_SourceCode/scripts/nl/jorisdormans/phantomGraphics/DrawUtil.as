package nl.jorisdormans.phantomGraphics
{
   ...
   public class DrawUtil
   {
      ...
      public static function colorToIllumination(param1:uint) : Number
      {
         ...
         var _loc5_:uint;
         return (_loc5_ = uint(_loc2_ + (_loc3_ << 1) + _loc4_)) / 1024;
      }
      
      public static function lerpColor(param1:uint, param2:uint, param3:Number) : uint
      {
         var _loc4_:uint = uint((param1 & 16711680) >> 16);
         var _loc5_:uint = uint((param1 & 65280) >> 8);
         var _loc6_:uint = uint(param1 & 255);
         var _loc7_:uint = uint((param2 & 16711680) >> 16);
         var _loc8_:uint = uint((param2 & 65280) >> 8);
      ...
      {
         var _loc7_:XML;
         (_loc7_ = <circle/>).@cx = param1.toFixed(2);
      ...
      {
         var _loc8_:XML;
         (_loc8_ = <rect/>).@x = param1.toFixed(2);
      ...
      {
         var _loc10_:XML;
         (_loc10_ = <rect/>).@x = param1.toFixed(2);
