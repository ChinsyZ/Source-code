package nl.jorisdormans.utils
{
   ...
   public class MathUtil
   {
      ...
      public static function intersection(param1:Vector3D, param2:Vector3D, param3:Number, param4:Vector3D, param5:Vector3D, param6:Number) : Number
      {
         ...
         var _loc10_:Number;
         if((_loc10_ = param2.x * param5.y - param2.y * param5.x) == 0)
         {
            return -1;
         }
         var _loc11_:Number;
         if((_loc11_ = _loc9_ / _loc10_) <= 0 || _loc11_ >= param3)
         {
            return -1;
         }
         ...
         var _loc16_:Number;
         if((_loc16_ = _loc14_ * param5.x + _loc15_ * param5.y) > 0 && _loc16_ < param6)
         {
            return _loc16_;
         }
         return -1;
      ...
      public static function closestPointOnLine(param1:Vector3D, param2:Vector3D, param3:Number, param4:Vector3D) : Number
      {
         ...
         var _loc7_:Number;
         if((_loc7_ = _loc5_ * param2.x + _loc6_ * param2.y) < 0)
         {
            _loc7_ = 0;
         }
         if(_loc7_ > param3)
      ...
      {
         var _loc4_:Vector3D;
         return (_loc4_ = new Vector3D(param3.y,-param3.x,0)).dotProduct(param2.subtract(param1)) > 0;
      }
