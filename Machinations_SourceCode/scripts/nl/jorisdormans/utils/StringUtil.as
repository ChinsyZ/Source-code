   ...
   public class StringUtil
   {
      ...
      private static function doEvaluateValue(param1:String, param2:int, param3:String) : int
      {
         ...
         else
         {
            ...
            if(_loc11_ > 0)
            {
               _loc12_ = parseInt(_loc8_.substr(0,_loc11_));
            }
            _loc13_ = 0;
      ...
      public static function floatToStringMaxPrecision(param1:Number, param2:int) : String
      {
         ...
         var _loc5_:String;
         var _loc4_:Number;
         if((_loc6_ = (_loc5_ = (_loc4_ = Math.floor(param1 * _loc3_) / _loc3_).toString()).indexOf(".")) >= 0 && _loc6_ < _loc5_.length - param2 - 1)
         {
